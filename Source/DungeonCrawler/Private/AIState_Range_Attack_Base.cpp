...
TUniquePtr<AIDecisionTreeNode> AIState_Range_Attack_Base::BuildInRange(AEnemy* Enemy)
{
    ...
    TUniquePtr<AIDecisionTreeNode> Attack = DecisionTreeHelper::MakeLeafNode([Enemy]() {Enemy->Attack(); });
    TUniquePtr<AIDecisionTreeNode> Defense = DecisionTreeHelper::MakeLeafNode([this]() {AIEnemyController->ChangeAIState(AIEnemyController->DefenseState.Get()); });
    TUniquePtr<AIDecisionTreeNode> Defense2 = DecisionTreeHelper::MakeLeafNode([this]() {AIEnemyController->ChangeAIState(AIEnemyController->DefenseState.Get()); });
