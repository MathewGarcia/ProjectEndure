 ...
 * 
 */
class DUNGEONCRAWLER_API AIState_Defense : public AIStateBase
{
public:
	AIState_Defense();
	...
	AIDecisionTreeNode* PrebuiltOriginal;

	AIDecisionTreeNode* PrebuiltBlockOrDodge;

	TUniquePtr<AIDecisionTreeNode> BuildBlock(AEnemy* Enemy);
